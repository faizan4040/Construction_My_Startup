...
const bookingSchema = new mongoose.Schema(
  {
    ...
    // Snapshot of category at booking time (helpers, masons, electricians, etc.)
    category: {
      type: String,
      required: true,
    },

    // Where the labour needs to work
    workAddress: {
      type: String,
      required: true,
    },
    ...
    // OTP to confirm labour has started work at the site
    startOtp: {
      type: String,
    },
    startOtpExpires: {
