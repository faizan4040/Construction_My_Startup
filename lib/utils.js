...
// ── Backward-compat alias — purani admin pages (jaise product-variant
// edit) abhi bhi `sizes` import karti hain; naya code `units` use
// karta hai, ye sirf un purani files ko todne se bachane ke liye hai ──
export const sizes = units