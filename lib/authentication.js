...
/**
 * @param {string | string[] | undefined} role
 *   - undefined -> any authenticated user is allowed (no role restriction)
 *   - string    -> exact role match required (existing behaviour)
 *   - string[]  -> user's role must be one of the given roles
 */
