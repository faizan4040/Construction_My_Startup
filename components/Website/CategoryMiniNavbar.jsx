...
import { ChevronDown, Menu, Calculator } from "lucide-react"
    ...
    <div ref={wrapRef} className="bg-gray-800 text-white border-t border-gray-700 relative z-40">
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:flex items-center justify-between">
          ...
          {/* ── Cost Calculator button (top-right corner) ── */}
          <button
            type="button"
            onClick={goToCalculator}
            className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium rounded-full bg-orange-500 hover:bg-orange-600 text-white transition-colors duration-200 cursor-pointer shrink-0"
          >
            <Calculator size={15} />
            Cost Calculator
          </button>
        ...
        <div className="lg:hidden">
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex-1 flex items-center gap-2 py-3 text-sm font-medium cursor-pointer"
            >
              <Menu size={16} />
              All Categories
            ...
            {/* ── Cost Calculator icon button (mobile, right corner) ── */}
            <button
              type="button"
              onClick={goToCalculator}
              aria-label="Cost Calculator"
              className="flex items-center justify-center w-9 h-9 rounded-full bg-orange-500 hover:bg-orange-600 text-white transition-colors duration-200 cursor-pointer shrink-0"
            >
              <Calculator size={16} />
            </button>
          </div>
