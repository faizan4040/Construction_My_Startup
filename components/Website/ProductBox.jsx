...
const ProductBox = ({ product }) => {
  ...
  // Actual purchasable pricing lives on the Variant, not the base Product
  // (different sizes/weights can have different prices). Fall back to the
  // product's own mrp/sellingPrice only if it has no variants at all.
