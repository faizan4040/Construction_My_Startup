...
const MapOverview = () => {
  ...
  const { data } = useFetch("/api/shopowner/dashboard/orders-by-state")
  ...
  return (
    <Card className="rounded-2xl sm:rounded-3xl shadow-sm border-gray-200/70 flex flex-col overflow-hidden">
      <div className="h-1.5 bg-violet-500" />
      <CardHeader className="pt-4">
        <p className="text-xs text-gray-400 font-medium">Reach</p>
        <CardTitle className="text-lg font-semibold">Where Your Orders Come From</CardTitle>
      </CardHeader>
