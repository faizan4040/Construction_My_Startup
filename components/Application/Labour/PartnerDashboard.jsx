...
function PartnerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-100 to-gray-200 px-4 pt-12 pb-20">
...
//     const interval = setInterval(refreshUser, 5000); // fir har 5 second me
...
//               icon={<Check size={18} />}
//               title="Video KYC approved"
//               desc="Your account will go live shortly."
//             />
//           ) : userData?.videoKycStatus === "rejected" ? (
//             <RejectionCard
//               title="Video KYC Rejected"
...
//         {activeStep === 6 && userData?.partnerStatus === "pending" && (
//           <StatusCard
//             icon={<Clock size={18} />}
//             title="Pricing Under Review"
//             desc="Admin is reviewing your submitted pricing."
...
//         {activeStep === 6 && userData?.partnerStatus === "rejected" && (
//           <RejectionCard
//             title="Pricing Rejected"
//             reason={userData?.rejectionReason}
//             actionLabel="Edit & Resubmit"
