...
export async function PUT(request) {
  try {
    ...
    // YAHI MISSING PIECE THA — pehle order-level `status` kabhi update hi
    // nahi hota tha jab shopowner apna status change karta tha, isliye customer
    // ko hamesha purana/stuck status dikhta tha. Ab dono side se update ek hi
    // unified logic se overall status set karte hain.
