...
const faqs = [
  {
    title: 'How do I get my Constructezy discount?',
    content:
      'Simply sign in with Constructezy Beans or UNiDAYS to verify your Constructezy status. Once verified, you will receive a single-use promo code.'
  },
  {
    title: 'Can I receive a discount as a graduate?',
    content:
      'Graduate discounts are subject to the terms of Constructezy Beans and UNiDAYS. Please check directly with the platform.'
  },
  {
    title: 'What Constructezy discount does Constructezy.com offer?',
    content:
      'We currently offer 12% off to verified Constructezys on selected products.'
  },
  {
    title: 'How often can I use my Constructezy discount code?',
    content:
  ...
  },
  {
    ...
    content:
      'New codes are issued based on Constructezy Beans or UNiDAYS eligibility rules.'
  },
  {
    title: 'Why does my Constructezy discount code not work?',
    content:
      'Some items and brands may be excluded. Ensure the code is unused and applied correctly.'
  },
  {
    title: 'Are there any items or brands excluded from the Constructezy discount?',
    content:
      'We are currently offering 12% off our AW25 collection. Selected items may be excluded. Maurten, Garmin, and COROS items are excluded. Sale items are excluded. Please see UNiDAYS or Constructezy Beans terms for full details.'
  },
]

const ConstructezyDiscount = () => {
  return (
    <div className="w-full">
      ...
      <div className="px-6 lg:px-24 py-6 text-sm text-gray-600">
        Home / <span className="text-black font-medium">Constructezys</span>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div>
            <h2 className="text-7xl mb-4 font-sans">
              Welcome to the Constructezy Discount Page
            </h2>
          </div>
          ...
          <div className="text-gray-700 space-y-4">
            <p>
              <strong>Constructezy.com</strong> are offering <strong>12% off</strong> our
              newest season to verified Constructezys – simply sign in with either
              Constructezy Beans or UNiDAYS and start saving!
            </p>

            <p>
              Join or sign in to one of our Constructezy discount programmes to verify
              your Constructezy status today. Once verified, you'll receive a
    ...
    <section className="w-full bg-gray-100 py-12 px-6">
      <div >
        <p className="text-gray-700 leading-relaxed text-center">
          ...
          <br /><br />
          Please see the <strong>UNiDAYS</strong> or <strong>ConstructezyBeans</strong> terms
...
export default ConstructezyDiscount
