...
const PrivacyPolicy = () => {
  ...
  const activeIndex = sections.findIndex((s) => s.key === active) + 1
      ...
      <section className="relative bg-[#14161A] text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <p className="mt-4 text-[#C9CCD1] text-lg max-w-2xl">
            How Constructezy collects, uses, and protects your personal
            information across our delivery and labour hire services.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-10">
                  ...
                  return (
                    <li key={item.key}>
                      <button
                        ...
                        className={`w-full flex items-start gap-3 text-left py-2.5 pl-4 border-l-2 transition-colors duration-200
                          ${isActive
                      ...
                      >
                        <span
                          className={`text-[11px] font-mono pt-0.5 shrink-0 ${
                            isActive ? 'text-[#F97316]' : 'text-[#9098A0]'
                          }`}
                        >
          ...
          <main className="lg:col-span-3 relative bg-white border border-black/5 p-8 lg:p-14">
            ...
            <span className="block text-[11px] font-mono uppercase tracking-[0.3em] text-[#F97316] mb-6">
              Section {String(activeIndex).padStart(2, '0')} / {sections.length}
            </span>

            <div className="prose-content [&_a]:text-[#F97316] [&_a]:underline [&_a:hover]:text-[#14161A] [&_strong]:text-[#14161A] [&_strong]:font-semibold">

              {/* PROMISE */}
              {active === 'promise' && (
                <>
                  <h1 className="text-3xl font-extrabold mb-6 tracking-tight">Our Privacy Promise</h1>
                  <p className="text-[#3A3D42] leading-relaxed mb-4">
              ...
              {active === 'collect' && (
                <>
                  ...
                  <h4 className="font-semibold mt-6 mb-2 text-[#14161A]">Information You Provide Directly</h4>
                  <ul className="list-disc pl-6 text-[#3A3D42] space-y-2 marker:text-[#F97316]">
                  ...
                  <h4 className="font-semibold mt-6 mb-2 text-[#14161A]">Information Collected Automatically</h4>
                  <ul className="list-disc pl-6 text-[#3A3D42] space-y-2 marker:text-[#F97316]">
                  ...
                  <h4 className="font-semibold mt-6 mb-2 text-[#14161A]">Information About Workers (Labour Hire)</h4>
                  <ul className="list-disc pl-6 text-[#3A3D42] space-y-2 marker:text-[#F97316]">
              ...
              {active === 'when' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">When Do We Collect Your Data?</h2>
                  <ul className="list-disc pl-6 text-[#3A3D42] space-y-2 marker:text-[#F97316]">
              ...
              {active === 'how' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">How and Why We Use Your Personal Data</h2>

                  <h4 className="font-semibold mt-6 mb-2 text-[#14161A]">30-Minute Delivery Services</h4>
                  <ul className="list-disc pl-6 text-[#3A3D42] space-y-2 marker:text-[#F97316]">
                  ...
                  <h4 className="font-semibold mt-6 mb-2 text-[#14161A]">Labour Hire Services</h4>
                  <ul className="list-disc pl-6 text-[#3A3D42] space-y-2 marker:text-[#F97316]">
                  ...
                  <h4 className="font-semibold mt-6 mb-2 text-[#14161A]">General Platform Operations</h4>
                  <ul className="list-disc pl-6 text-[#3A3D42] space-y-2 marker:text-[#F97316]">
              ...
              {active === 'sharing' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">Sharing Your Data with Third Parties</h2>
                  <p className="text-[#3A3D42] leading-relaxed mb-4">
                  ...
                  <p className="text-[#3A3D42] leading-relaxed mt-4">
              ...
              {active === 'protect' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">How We Protect Your Data</h2>
                  <p className="text-[#3A3D42] leading-relaxed mb-4">
              ...
              {active === 'where' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">Where Your Data May Be Stored and Processed</h2>
                  <p className="text-[#3A3D42] leading-relaxed mb-4">
              ...
              {active === 'retain' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">How Long Do We Keep Your Data?</h2>
                  <p className="text-[#3A3D42] mb-4">
              ...
              {active === 'rights' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">Your Rights Relating to Your Data</h2>
                  <p className="text-[#3A3D42] mb-4">
              ...
              {active === 'children' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">Privacy of Children On Our Website</h2>
                  <p className="text-[#3A3D42] leading-relaxed mb-4">
              ...
              {active === 'changes' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">Changes to Our Privacy Statement</h2>
                  <p className="text-[#3A3D42] leading-relaxed mb-4">
              ...
              {active === 'contact' && (
                <>
                  <h2 className="text-3xl font-extrabold mb-6 tracking-tight">Contact Us</h2>
                  <p className="text-[#3A3D42] mb-3">
